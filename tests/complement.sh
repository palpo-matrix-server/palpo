...
env \
    ...
    go test -tags="palpo_blacklist" "$SKIPPED_COMPLEMENT_TESTS" -timeout 1h -run "TestInboundFederationProfile/Inbound_federation_can_query_profile_data" -json ./tests/ ./tests/csapi| tee "$LOG_FILE.jsonl"
set -o pipefail

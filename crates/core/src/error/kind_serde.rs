...
use crate::serde::{DeserializeFromCowStr, FromString};
use serde::{
...
enum ErrCode {
    ...
    BadAlias,
    DuplicateAnnotation,
    #[palpo_enum(alias = "FI.MAU.MSC2246_NOT_YET_UPLOADED")]
    NotYetUploaded,
    #[palpo_enum(alias = "FI.MAU.MSC2246_CANNOT_OVERWRITE_MEDIA")]

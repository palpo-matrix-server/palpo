    ...
    pub fn data(&self) -> Cow<'_, JsonObject> {
        ...
        match self {
            ...
            Self::EmailIdentity(x) => Cow::Owned(serialize(EmailIdentity {
                threepid_creds: x.threepid_creds.clone(),
                session: None,
            })),
...
pub struct EmailIdentity {
    ...
    pub threepid_creds: ThirdpartyIdCredentials,
...
impl UiaaInfo {
    ...
    ///
    /// ```
    /// # use palpo_core::client::uiaa::UiaaInfo;
    /// use palpo_core::client::uiaa::{AuthType, LoginTermsParams};
    ///

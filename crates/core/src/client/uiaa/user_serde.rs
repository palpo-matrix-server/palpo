...
//         assert_eq!(
//             to_json_value(UserIdentifier::Email {
//                 address: "me@myprovider.net".to_owned()
//             })
//             .unwrap(),
//             json!({
...
//         assert_eq!(
//             to_json_value(UserIdentifier::Msisdn {
//                 number: "330102030405".to_owned()
//             })
//             .unwrap(),
//             json!({
//                 "type": "m.id.thirdparty",
...
//             Ok(UserIdentifier::PhoneNumber { country, phone })
//         );

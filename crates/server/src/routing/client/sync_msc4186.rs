...
fn collect_e2ee<'a>(
    (sender_id, sender_device, global_since_sn, body): (
        &UserId,
        &DeviceId,
        Seqnum,
        &SyncEventsReqBody,
    ...
    device_list_changes.extend(data::user::keys_changed_users(
        sender_id,
        global_since_sn,
        None,
    )?);
    ...
    for room_id in all_joined_rooms {
        ...
        device_list_changes.extend(crate::room::keys_changed_users(
            room_id,
            global_since_sn,
            None,
        )?);
